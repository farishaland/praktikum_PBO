...
// Kelas abstrak (induk) - Polymorphism: method getJenis akan dioverride
abstract class Laporan {
    ...
    public abstract String getJenis(); // Override wajib di subclass
...
// Subclass 1 - Overriding getJenis
...
// Subclass 2 - Overriding getJenis
...
public class MainLaporan {
    ...
    // ✅ Overload method tambahData (Polymorphism Overloading)
    ...
    // Versi normal (input manual dari user)
